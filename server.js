...
//         //s'hauria de comprobar si estar caducada
//         let clientId = service.checkToken(token);        
//         const result = await Client.findOne({ _id: clientId }).select("email").lean();
//         if (result.rol=='xofer' || result.email=="admin@taxionline.cat"){
...
//         let clientId = service.checkToken(token);        
//         const result = await Client.findOne({ _id: clientId }).select("email").lean();
//         if (result.email=="admin@taxionline.cat"){
